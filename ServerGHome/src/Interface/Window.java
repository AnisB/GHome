...
public class Window extends javax.swing.JFrame {
    ...
    public Window(Lieu a, ServerGHome m) {
        ...
        map.setBounds(0, 0, map.size * a.nombreEtage, map.size);
        map.setVisible(true);
        this.add(map);
        this.setSize(map.size * a.nombreEtage, map.size*2);
        mapSave = new javax.swing.JButton();
        mapSave.setLocation(map.size*3/2, map.size*3/2);
